				...
				<div class="container">
					<div class="row">
						<div class="container container--mini">
							<form name="loginform" id="form" action="form.php" method="post">

								<div class="form-group">
									<label for="user_login">Username</label>
									<input type="text" name="name" id="name" class="form-control" value="" placeholder="username: niru" size="20" required>
								</div>
								<div class="form-group">
									<label for="user_pass">Password</label>
									
									<input type="password" name="pass" id="pass" class="form-control" value="" placeholder="username: 123" size="20" required>
								</div>
